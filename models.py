...
class Student(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-enrolments.student','-enrolments.course_id','-enrolments.id','-enrolments.student_id','-enrolments.course.id')
...
class Enrolment(db.Model, SerializerMixin):
    ...
    serialize_rules = ('-student.enrolments', '-course.enrolments', '-id')
    ...
    def __repr__(self):
        return f"<Student {self.id} is enrolled in Course {self.id}>"